...
export class NosProduitsComponent implements OnInit {
  ...
  onSelect(e) {
    this.modeleService
      .getAllModelesByMarque_id(e.target.value)
      .subscribe((data) => {
  ...
  onSubmit() {
    if (
      this.selectedModele.id == 0 &&
      this.selectedGouvernorat.id == 0 &&
      this.selectedDelegation.id == 0 &&
      this.selectedMarque.id == 0
    ) {
      this.produitService
        .listeProduitsByCategorie(this.selectedCategorie.id)
        .subscribe((data) => {
          this.produits = data;
        });
    } 
      ...
      this.produitService
        .listeProdduitsByMarqueAndCategorie(
          this.selectedMarque.id,
      ...
      this.selectedCategorie.id == 0 &&
      this.selectedGouvernorat.id == 0 &&
      this.selectedDelegation.id == 0 &&
      this.selectedModele.id == 0
    ) {
      this.produitService
        .listeProdduitsByMarque(this.selectedMarque.id)
        .subscribe((d) => {
          this.produits = d;
        });
    }
      ...
      this.produitService
      .listeProdduitsByModeleAndCategorieAndMarque(
        this.selectedModele.id,
        this.selectedCategorie.id,
        this.selectedMarque.id
      )
      .subscribe((d)=>{
      ...
      this.produitService
        .listeProdduitsByModele(this.selectedModele.id)
        .subscribe((d) => {
          this.produits = d;
        });
    } 
      ...
      this.produitService
        .listeProdduitsByGouvernorat(this.selectedGouvernorat.id)
        .subscribe((d) => {
          this.produits = d;
        });
    } else if (
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndMarque(
          this.selectedGouvernorat.id,
          this.selectedMarque.id
        )
        .subscribe((d) => {
          this.produits = d;
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndCategorie(
          this.selectedGouvernorat.id,
          this.selectedCategorie.id
        )
        .subscribe((data) => {
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndMarqueAndCategorie(
          this.selectedGouvernorat.id,
          this.selectedMarque.id,
          this.selectedCategorie.id
        )
      ...
      this.produitService
        .listeProdduitsByModeleAndCategorieAndGouvernorat(
          this.selectedModele.id,
          this.selectedCategorie.id,
          this.selectedGouvernorat.id
        )
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndDelegation(
          this.selectedGouvernorat.id,
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndDelegationAndMarqueAndCategorie(
          this.selectedGouvernorat.id,
          this.selectedMarque.id,
          this.selectedDelegation.id,
          this.selectedCategorie.id
    ...
    //
      ...
      this.produitService
        .listeProdduitsByDelegationAndCategorie(
          this.selectedDelegation.id,
          this.selectedCategorie.id
        )
        .subscribe((data) => {
      ...
      this.produitService
        .listeProdduitsByGouvernoratAndDelegationAndMarque(
          this.selectedGouvernorat.id,
          this.selectedMarque.id,
          this.selectedDelegation.id
        )
      ...
      this.produitService
        .listeProdduitsByDelegationAndModeles(
          this.selectedDelegation.id,
          this.selectedModele.id
        )
        .subscribe((d) => {
      ...
      this.produitService
        .listeProdduitsByModeleAndCategorieAndGouvernoratAndDelegation(
          this.selectedModele.id,
          this.selectedCategorie.id,
          this.selectedGouvernorat.id,
          this.selectedDelegation.id
